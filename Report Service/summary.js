...
function inflateResponses() {
  ...
  garage.innerHTML = _strings[_form.questions[GARAGE].options[_myFormResponses.questionToAnswerMap[
    GARAGE]].text];
  ...
  partsNeeded.innerHTML = _myFormResponses.questionToAnswerMap[PARTSNEEDED];
